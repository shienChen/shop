            ...
            <!-- Tab 页签区域 -->
             <el-tabs v-model="activeName" @tab-click="handleTabClick">
                ...
                <el-tab-pane label="动态参数" name="many"> 
                    <el-button type="primary" size="mini" :disabled="isBtnDiasabled" @click="addDialogVisible = true">添加参数</el-button> 
                    <!-- 动态参数表格 -->
                ...
                <el-tab-pane label="静态属性" name="only">
                    <el-button type="primary" size="mini" :disabled="isBtnDiasabled" @click="addDialogVisible = true">添加属性</el-button> 
                    <!-- 静态参数表格 -->
    ...
    export default {
        ...
        methods: {
            ...
            showInput(row){
                ...
                // 让文本框自动获取焦点
                // $nextTick 方法的作用，就是当页面元素被重新渲染后，才会指定回调函数中的代码
                this.$nextTick(_ => {
