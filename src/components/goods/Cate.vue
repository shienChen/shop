<template>
  <div>
        ...
        <el-dialog
            ...
            >
            <el-form ref="editFormRef" v-model="editForm" :rules="editFormRules" label-width="100px">
                <el-form-item label="分类名称：" prop="cat_name" >
    ...
    export default {
        ...
        methods: {
            ...
            async removeCateById(id){
                const res1 = await this.$confirm('此操作将永久删除该用户, 是否继续?', '提示', {
